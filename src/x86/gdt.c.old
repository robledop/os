...
//     {.base = (uint32_t)&tss, .limit = sizeof(tss) - 1, .type = 0xE9}, // TSS
// };
...
void init_gdt()
{
    ...
    gdt_set_segment(gdt + GDT_USER_CODE, 0, 0xfffff, GDT_CODE_SEGMENT, PROCESSS_PRIVILEGE, MEMORY);
    gdt_set_segment(gdt + GDT_USER_DATA, 0, 0xfffff, GDT_DATA_SEGMENT, PROCESSS_PRIVILEGE, MEMORY);
