...
;  int os_wait_pid(int pid);
;global os_wait_pid:function
;os_wait_pid:
;    push ebp
;    mov ebp, esp
;    push dword [ebp + 8]  ; pid
;    mov eax, 17           ; sys_wait_pid command
;    int 0x80
;    add esp, 4
;    pop ebp
;    ret
...
; void os_reboot();
;global os_reboot:function
;os_reboot:
;    push ebp
;    mov ebp, esp
;    mov eax, 18          ; sys_reboot command
;    int 0x80
;    pop ebp
;    ret
;
;; void os_shutdown();
;global os_shutdown:function
;os_shutdown:
;    push ebp
;    mov ebp, esp
;    mov eax, 19          ; sys_shutdown command
;    int 0x80
;    pop ebp
;    ret