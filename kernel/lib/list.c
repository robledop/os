...
{
    ASSERT(list != NULL, "list_init: list is NULL");
    list->head.prev = NULL;
...
{
    ASSERT(list != NULL, "list_begin: list is NULL");
...
{
    ASSERT(is_head(elem) || is_interior(elem), "list_next: elem is not a head or interior element");
    return elem->next;
}
...
{
    ASSERT(list != NULL, "list_end: list is NULL");
    return &list->tail;
}
...
{
    ASSERT(list != NULL, "list_rbegin: list is NULL");
...
{
    ASSERT(is_interior(elem) || is_tail(elem), "list_prev: elem is not an interior or tail element");
    return elem->prev;
}
...
{
    ASSERT(list != NULL, "list_rend: list is NULL");
    return &list->head;
}
...
{
    ASSERT(list != NULL, "list_head: list is NULL");
    return &list->head;
}
...
{
    ASSERT(list != NULL, "list_tail: list is NULL");
    return &list->tail;
}
...
{
    ASSERT(is_interior(before) || is_tail(before), "list_insert: before is not an interior or tail element");
    ASSERT(elem != NULL, "list_insert: elem is NULL");
...
{
    ASSERT(is_interior(before) || is_tail(before), "list_splice: before is not an interior or tail element");
    if (first == last)
        return;
    last = list_prev(last);

    ASSERT(is_interior(first), "list_splice: first is not an interior element");
    ASSERT(is_interior(last), "list_splice: last is not an interior element");
...
{
    ASSERT(is_interior(elem), "list_remove: elem is not an interior element");
...
{
    ASSERT(!list_empty(list), "list_front: list is empty");
    return list->head.next;
}
...
{
    ASSERT(!list_empty(list), "list_back: list is empty");
    return list->tail.prev;
}
...
{
    ASSERT(a != NULL, "find_end_of_run: a is NULL");
    ASSERT(b != NULL, "find_end_of_run: b is NULL");
    ASSERT(less != NULL, "find_end_of_run: less is NULL");
    ASSERT(a != b, "find_end_of_run: a == b");
...
static void inplace_merge(struct list_elem *a0, struct list_elem *a1b0, struct list_elem *b1, list_less_func *less,
                          void *aux)
{
    ASSERT(a0 != NULL, "inplace_merge: a0 is NULL");
    ASSERT(a1b0 != NULL, "inplace_merge: a1b0 is NULL");
    ASSERT(b1 != NULL, "inplace_merge: b1 is NULL");
    ASSERT(less != NULL, "inplace_merge: less is NULL");
    ASSERT(is_sorted(a0, a1b0, less, aux), "inplace_merge: a0 to a1b0 is not sorted");
    ASSERT(is_sorted(a1b0, b1, less, aux), "inplace_merge: a1b0 to b1 is not sorted");
