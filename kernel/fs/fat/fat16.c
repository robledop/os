...
int fat16_sector_to_absolute(const struct disk *disk, const int sector) { return sector * disk->sector_size; }
...
struct fat_directory_entry *fat16_clone_fat_directory_entry(const struct fat_directory_entry *entry,
                                                            const size_t size) {
